// src/sections/mission/CampaignSettingsPane.jsx
...
export default function CampaignSettingsPane() {
  ...
  if (!campaign) {
    return (
      <div className="max-w-5xl mx-auto">
        <section className="rounded-2xl bg-[var(--dash-surface)] border border-[var(--dash-border)]/60 p-6 text-center text-sm text-[var(--dash-muted)]">
          <p className="font-medium text-[var(--dash-text)]">No active campaign yet.</p>
          <p className="mt-1 text-xs text-[var(--dash-muted)]/80">
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <section className="rounded-2xl bg-[var(--dash-surface)] border border-[var(--dash-border)]/60 p-4 sm:p-5">
        <div className="flex items-start justify-between gap-3">
          <div className="flex-1">
            <p className="text-[11px] uppercase tracking-[0.2em] text-[var(--dash-muted)]/70">
              Active campaign
            </p>
            <div className="mt-1 flex items-center gap-2">
              {isEditingName ? (
                <input
                  ...
                  className="min-w-[180px] rounded-md bg-[var(--dash-bg)] border border-[var(--dash-border)] px-2 py-1 text-sm text-[var(--dash-text)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]/70"
                  autoFocus
                />
              ) : (
              ...
              <button
                ...
                className="inline-flex h-6 w-6 items-center justify-center rounded-full border border-[var(--dash-border)] bg-[var(--dash-bg)] text-[11px] text-[var(--dash-muted)] hover:border-[var(--accent)] hover:text-[var(--accent)] transition-colors"
        ...
        <p className="mt-3 text-[11px] text-[var(--dash-muted)]/70">
      ...
      <section className="rounded-2xl bg-[var(--dash-surface)] border border-[var(--dash-border)]/60 p-4 sm:p-5">
        <h3 className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--dash-muted)] mb-4">
          Audience & Targeting
        </h3>
        ...
        <div className="space-y-4">
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Age range</label>
              <div className="flex items-center gap-2">
                <input
                  ...
                  placeholder="Min"
                  className="w-full rounded-md bg-[var(--dash-bg)] border border-[var(--dash-border)] px-2 py-1.5 text-xs text-[var(--dash-text)] focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]/70"
                />
                <span className="text-xs text-[var(--dash-muted)]">to</span>
                <input
                  type="number"
                  min="13"
                  max="99"
              ...
              {!ageRange.min && !ageRange.max && (
                <p className="mt-1 text-[10px] text-[var(--dash-muted)]/70">
            ...
            <div>
              <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Targeting style</label>
              <select
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Key locations to prioritise</label>
            <input
              type="text"
              ...
              className="w-full rounded-md bg-[var(--dash-bg)] border border-[var(--dash-border)] px-2 py-1.5 text-xs text-[var(--dash-text)] placeholder:text-[var(--dash-muted)]/50 focus:outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)]/70"
            />
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Interests & intent signals</label>
            <textarea
          ...
          {localConfig.platforms && localConfig.platforms.length > 0 ? (
            localConfig.platforms.map((p, idx) => (
              <li key={idx} className="inline-flex items-center gap-2">
                ...
                <span className="text-[var(--dash-text)]/90">{p}</span>
              </li>
            ))
          ) : (
            <li className="text-[var(--dash-muted)]/70">
              No platforms set yet. Add at least one so we know where to deploy.
            </li>
          )}
        </ul>
        <div>
          <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Edit platforms</label>
          <input
            type="text"
            value={platformsText}
            onChange={(e) => {
      ...
      <section className="rounded-2xl bg-[var(--dash-surface)] border border-[var(--dash-border)]/60 p-4 sm:p-5">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Website / landing page</label>
            <input
              type="url"
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Time zone</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Campaign length (days)</label>
            <input
              type="number"
              min="1"
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Start date</label>
            <input
              type="date"
          ...
          <div>
            <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">End date</label>
            <input
              type="date"
      ...
      <section className="rounded-2xl bg-[var(--dash-surface)] border border-[var(--dash-border)]/60 p-4 sm:p-5">
        ...
        <div>
          <label className="block text-[11px] text-[var(--dash-muted)] mb-1.5">Contact email</label>
          <input
            type="email"
