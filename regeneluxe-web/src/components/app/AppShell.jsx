      ...
      >
        ...
        <div className="mt-auto space-y-1 border-t border-rl_border px-2 py-3">
          <NavLink
            ...
            title="Queue"
            aria-label="Queue"
            className={({ isActive }) => navClass(isActive, collapsed, "py-2")}
          >
      ...
      <div className="sticky top-0 z-40 border-b border-rl_border bg-rl_surface/95 backdrop-blur lg:hidden">
        <div className="flex items-center justify-between gap-2 px-3 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <button type="button" className="rl-btn px-3 py-2" onClick={() => navigate("/content/new")} aria-label="Create">
        ...
        <nav className="flex gap-1 overflow-x-auto px-2 pb-2" aria-label="Main mobile">
          ...
          <NavLink to="/queue" className="whitespace-nowrap rounded-lg px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-rl_muted">
            Queue
          </NavLink>
          <NavLink to="/settings" className="whitespace-nowrap rounded-lg px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.1em] text-rl_muted">
            Settings
          </NavLink>
        </nav>
      </div>
