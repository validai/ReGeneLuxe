...
export default function EmptyState({ title, body, action, icon = "sparkle" }) {
  return (
    <div className="rounded-2xl border border-dashed border-rl_border bg-rl_surfaceRaised/60 px-6 py-12 text-center">
      <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-rl_surfaceActive text-rl_text">
